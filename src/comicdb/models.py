...
class ComicLogArchive(models.Model):
	id = models.IntegerField(primary_key=True)
	ComicId = models.ForeignKey(Comic, db_column="ComicId")
	ImageUrl = models.CharField(max_length=1000)
	FetchDate = models.DateTimeField()
...
class ComicRssArchive(models.Model):
	id = models.IntegerField(primary_key=True)
	ComicLogId = models.ForeignKey(ComicLogArchive, db_column="ComicLogId")

	class Meta:
		db_table = u'ComicRssArchive'
